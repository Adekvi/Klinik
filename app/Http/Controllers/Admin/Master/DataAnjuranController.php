...
class DataAnjuranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.master.dataanjuran.index', compact('anjuran', 'entries', 'search'));
    }
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect()->route('master-anjuran')->with('success', 'Data berhasil ditambah!');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return redirect()->route('master-anjuran')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function hapus($id)
    {
        ...
        return redirect()->route('master-anjuran')->with('success', 'Data berhasil dihapus!');
    }
}
