...
class PemeriksaanController extends Controller
{
    ...
    {
        return view('admin.rekapan.pemeriksaan.pemeriksaan-lab.index');
    }
    ...
    public function cetakLab(Request $request)
    {
        ...
        $html = View::make('admin.rekapan.pemeriksaan.pemeriksaan-lab.cetak', compact('data', 'filterInfo'))->render();
