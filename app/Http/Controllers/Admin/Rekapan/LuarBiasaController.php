...
class LuarBiasaController extends Controller
{
    public function indexlb()
    {
        return view('admin.rekapan.kejadian.luarbiasa.index');
    }

    public function searchlb(Request $request)
    {
    ...
    public function cetaklb(Request $request)
    {
        $type = $request->input('type');
        $searchData = $request->all();
        // dd($type);
        ...
        $html = View::make('admin.rekapan.kejadian.luarbiasa.cetak', compact('data', 'filterInfo'))->render();
