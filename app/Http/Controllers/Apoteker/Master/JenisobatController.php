...
class JenisobatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('obat.master.jenisobat.index', compact('jenis', 'search', 'entries'));
    }
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect()->route('apoteker.master-jenis')->with('success', 'Data berhasil ditambah!');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return redirect()->route('apoteker.master-jenis')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function hapus($id)
    {
        ...
        return redirect()->route('apoteker.master-jenis')->with('success', 'Data berhasil dihapus!');
    }
}
