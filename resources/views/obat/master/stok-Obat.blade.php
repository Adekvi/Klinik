...
@section('title', 'Apoteker | Stok Obat')
@section('kontent')
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="pasien-bpjs">
                    <div class="card-title">
                        ...
                        <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#"><i class="bi bi-plus-lg"></i> Tambah Obat</button>
                    </div>
                    <div class="tb-umum">
                        <table id="example" class="table table-striped table-bordered" style="width:100%;">
                            <thead>
                                ...
                                @php
                                    ...
                                    // dd($allSoapPatients);
                                @endphp
                                <tr class="table-primary text-center" style=" white-space: nowrap; justify-content: center">
                                    <th>No</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($allSoapPatients as $patientName)
                                                    ...
                                                    {{ $patientName }} : {{ json_decode($item['resep'], true)[$patientName] }}
                                                    @endif
                                                @endforeach
                                            </td>
