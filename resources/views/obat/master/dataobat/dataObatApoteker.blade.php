<x-admin.layout.terminal title="Apoteker | Master Data Obat">
                                ...
                                <form method="GET" action="{{ route('apoteker.master.obat') }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select name="entries" id="entries" class="form-select form-select-sm me-3"
                                            ...
                                            <option value="25" {{ request('entries', 10) == 25 ? 'selected' : '' }}>
                                                25
                                            </option>
                                            <option value="50" {{ request('entries', 10) == 50 ? 'selected' : '' }}>
                                                50
                                            </option>
                                            <option value="100"
                                                {{ request('entries', 10) == 100 ? 'selected' : '' }}>100
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <div class="tb-umum">
                                    <table id="example" class="table table-striped table-bordered"
                                        ...
                                        <tbody id="obat-table">
                                            @include('obat.master.dataobat.table', ['obat' => $obat])
                                        </tbody>
                                    </table>
                                </div>
                            </div>
    ...
    @include('obat.master.dataobat.tambah')
    @include('obat.master.dataobat.edit')
    @include('obat.master.dataobat.hapus')
