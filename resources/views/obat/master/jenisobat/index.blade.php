<x-admin.layout.terminal title="Apoteker | Data Jenis Obat">
    ...
    @include('obat.master.jenisobat.tambah')
    @include('obat.master.jenisobat.edit')
    @include('obat.master.jenisobat.hapus')
