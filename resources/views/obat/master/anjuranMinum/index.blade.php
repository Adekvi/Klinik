<x-admin.layout.terminal title="Apoteker | Data Anjuran Obat">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="halaman d-flex justify-content-end mt-2">
                                {{ $anjuran->appends(request()->only(['search', 'entries']))->links() }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('obat.master.anjuranMinum.tambah')
    @include('obat.master.anjuranMinum.edit')
    @include('obat.master.anjuranMinum.hapus')
