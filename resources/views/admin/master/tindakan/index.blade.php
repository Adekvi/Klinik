...
@section('title', 'Admin | Data Tindakan Dokter')
@section('content')
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="tindakan">
                <div class="card-title">
                    ...
                    <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#tindakan"><i class="fa-solid fa-square-plus"></i> Tambah</button>
                </div>
                <div class="tb-umum">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="aksi d-flex" >
                                            ...
                                            <button type="button" class="btn btn-danger mx-2" data-bs-toggle="modal" data-bs-target="#hapuspoli{{ $item->id }}">Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
