        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel" style="color: white">Hapus Tindakan</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ url('admin/master/tindakan/hapus/'. $item->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
