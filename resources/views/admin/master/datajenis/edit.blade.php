    ...
    <div class="modal fade" id="editpoli{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/master/jenis-edit/' . $item->id) }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis" id="jenis"
                                        value="{{ $item->jenis ?? '-' }}" class="form-control mt-2 mb-2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="golongan" id="golongan"
                                        value="{{ $item->golongan ?? '-' }}" class="form-control mt-2 mb-2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" id="keterangan"
                                        value="{{ $item->keterangan ?? '-' }}" class="form-control mt-2 mb-2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
