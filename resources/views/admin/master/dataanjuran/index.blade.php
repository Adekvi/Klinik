...
@section('title', 'Admin | Data Anjuran Obat')
@section('content')
    ...
    @include('admin.master.dataanjuran.tambah')
    @include('admin.master.dataanjuran.edit')
    @include('admin.master.dataanjuran.hapus')
@endsection
