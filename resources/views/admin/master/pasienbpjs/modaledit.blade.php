@foreach ($pasien as $item)
    <div class="modal fade" id="editbpjs{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="pasienbaru" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/tambah/pasienumum') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2 mb-2" name="jenis_bayar" id="jenis_bayar" value="BPJS" disabled>
                      </div>
                      <div class="form-group">
                        <label for="bpjs">No. BPJS</label>
                        <input type="text" class="form-control mt-2 mb-2" name="bpjs" id="bpjs" value="{{ $item->bpjs }}" placeholder="Masukkan No. BPJS">
                      </div>
                  </div>
