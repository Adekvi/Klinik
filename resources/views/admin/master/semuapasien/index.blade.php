                                ...
                                <form method="GET" action="{{ route('master.semuadata') }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select name="recent_entries" id="recent_entries"
                                            ...
                                            <option value="10"
                                                {{ request('recent_entries', 10) == 10 ? 'selected' : '' }}>
                                                10
                                            </option>
                                            <option value="25"
                                                {{ request('recent_entries') == 25 ? 'selected' : '' }}>25
                                            </option>
                                            <option value="50"
                                                {{ request('recent_entries') == 50 ? 'selected' : '' }}>50
                                            </option>
                                            <option value="100"
                                                {{ request('recent_entries') == 100 ? 'selected' : '' }}>100
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <tbody class="text-center">
                                            @foreach ($recentPatients as $index => $record)
                                                <tr>
                                                    ...
                                                    <td>{{ $record->no_rm }}</td>
                                                    <td>{{ !empty($record->nama_pasien) ? $record->nama_pasien : '-' }}
                                                    </td>
                                                    ...
                                                    <td>{{ !empty($record->pekerjaan) ? $record->pekerjaan : '-' }}
                                                    </td>
                                                    <td>{{ !empty($record->alamat_asal) ? $record->alamat_asal : '-' }}
                                                    </td>
                                                    <td>{{ !empty($record->noHP) ? $record->noHP : '-' }}</td>
                                                    <td>{{ !empty($record->jenis_pasien) ? $record->jenis_pasien : '-' }}
                                                    </td>
