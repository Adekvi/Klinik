<div class="modal fade" id="tambahuser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="pasienbaru" aria-hidden="true">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_dokter" id="id_dokter" class="form-control mt-2 mb-2">
                            ...
                            @foreach ($dokter as $dok)
                                <option value="{{ $dok->id }}">{{ $dok->nama_dokter }} - {{ $dok->profesi }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" class="form-control mt-2 mb-2" name="username" id="username" placeholder="Masukkan Username" required>
                    </div>
                    <div class="form-group">
