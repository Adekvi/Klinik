    ...
    <div class="modal fade" id="editpoli{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/master/shift-edit/' . $item->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-2 mb-2" name="nama_shift"
                                        id="nama_shift" value="{{ $item->nama_shift }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="jam_selesai" id="jam_selesai"
                                        class="form-control mt-2 mb-2" value="{{ $item->jam_selesai }}">
                                </div>
                            </div>
                        </div>
                    </div>
