<div class="modal fade" id="editdokter{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="poli" id="poli" class="form-control mt-2 mb-2">
                            <option value="0" {{ $item->id_poli == 0 ? 'selected' : '' }}>Tidak ada Poli</option>
