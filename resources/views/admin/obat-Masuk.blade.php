...
@section('title', 'Admin | Rekap Obat Masuk')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
            <div class="pasien-bpjs">
                <div class="title">
                    <h5><strong>Obat Masuk</strong></h5>
                </div>
                <div class="card" style="width: 40%; margin-bottom: 20px">
                    <div class="card-body">
                        ...
                        <div class="button" style="display: flex; align-items: baseline">
                            ...
                            <button type="button" id="btnCetak" class="btn btn-warning mt-3" style="margin-left: 10px"><i class="fas fa-download"></i> Unduh</button>
                        </div>
                    </div>
                </div>
                <div class="card">
                            ...
                            <tbody>
                                @foreach ($apotek as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-bs-target="#ubah{{ $item->id }}" data-bs-toggle="modal" class="btn btn-primary">
...
@foreach ($obat as $item)
    <div class="modal fade" id="riwayat{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabelAsesmen{{ $item->id }}" aria-hidden="true">
    ...
    document.addEventListener('DOMContentLoaded', function () {
            ...
            btnSearch.addEventListener('click', function () {
                ...
                if (filterByMonthYear.checked) {
                    ...
                    searchData = { type: 'month_year', month: selectedMonth, year: selectedYear };
                } else if (filterByFullDate.checked) {
                    const selectedDate = tanggalInput.value;
                    searchData = { type: 'full_date', date: selectedDate };
                } else {
