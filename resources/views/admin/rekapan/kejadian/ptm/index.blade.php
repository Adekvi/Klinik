<x-admin.layout.terminal title="Admin | Rekap Penyakit Tidak Menular">
        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="title">
                        <h5><strong>Laporan Penyakit Tidak Menular (PTM)</strong></h5>
                    </div>
                    <div class="row">
                        <div class="col-5">
                            <div class="card" style="width: 100%; margin-bottom: 20px">
                                <div class="card-body">
                                    ...
                                    <p style="font-size: 14px; margin-bottom: 0px"><span style="color: red">*
                                        </span>Pilih
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h5 style="text-align: left; margin-bottom: -10px">0 - 14 Tahun</h5>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <h6 style="text-align: left; margin-bottom: 0px">Laki - Laki :
                                                    <span>6</span>
                                                    <br> Perempuan :<span>7</span>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h6 style="text-align: left; margin-bottom: -10px">15 - 59 Tahun</h6>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
                                                    style="font-size: 14px; font-weight: bold; text-align: left; margin-bottom: 0px">
                                                    Laki - Laki : <span>1</span>
                                                    <br> Perempuan :<span>9</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h6 style="text-align: left; margin-bottom: -10px">>= 65 Tahun</h6>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
                                                    style="font-size: 14px; font-weight: bold; text-align: left; margin-bottom: 0px">
                                                    Laki - Laki : <span>4</span>
                                                    <br> Perempuan :<span>5</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h6 style="text-align: left; margin-bottom: -10px">Total</h6>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
                                                    style="font-size: 14px; font-weight: bold; text-align: left; margin-bottom: 0px">
                                                    Laki - Laki : <span>10</span>
                                                    <br> Perempuan :<span>15</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                btnSearch.addEventListener('click', function() {
                    ...
                    fetch('/rekapan/kejadian-ptm/search', {
                            method: 'POST',
                            headers: {
                ...
                function cetakHasilFilter() {
                    ...
                    fetch('/rekapan/kejadian-ptm/cetak', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
