<x-admin.layout.terminal title="Admin | Kejadia Luar Biasa (KLB)">
        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="title">
                        <h5><strong>Laporan Kejadian Luar Biasa (KLB)</strong></h5>
                    </div>
                    <div class="row">
                        <div class="col-5">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h7 style="text-align: left; margin-bottom: -10px">0 - 14 Tahun</h7>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <h7 style="text-align: left; margin-bottom: 0px">L :
                                                    <span>6</span>
                                                    <br> P : <span>7</span>
                                                </h7>
                                            </div>
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h7 style="text-align: left; margin-bottom: -10px">15 - 59 Tahun</h7>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h7 style="text-align: left; margin-bottom: -10px">>= 65 Tahun</h7>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
                                ...
                                <div class="col-3">
                                    <div class="card" style="width: 100%; height: 100%;">
                                        <div class="card-body">
                                            <div class="umur">
                                                <h7 style="text-align: left; margin-bottom: -10px">Total</h7>
                                                <hr>
                                            </div>
                                            <div class="gender">
                                                <p
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                btnSearch.addEventListener('click', function() {
                    ...
                    fetch('/rekapan/kejadian/luarbiasa/search', {
                            method: 'POST',
                            headers: {
                ...
                function cetakHasilFilter() {
                    ...
                    fetch('/rekapan/kejadian/luarbiasa/cetak', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
