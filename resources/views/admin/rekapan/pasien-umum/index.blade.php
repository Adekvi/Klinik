                            ...
                            <div class="button" style="display: flex; align-items: baseline">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        {{-- <a class="dropdown-item" href="{{ url('/pasien-umum/export-excel') }}">Export to
                                            Excel</a> --}}
                                        ...
                                        @foreach ($umumUmum as $item)
                                            @if ($item->pasien->jenis_pasien == 'Umum')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Umum</td>
                                                    <td>Rp. {{ number_format($item->harga_keseluruhan) }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (count($resep))
                                                            @for ($i = 0; $i < count($resep); $i++)
                                                                - {{ array_keys($resep)[$i] }} <br>
                                                            @endfor
                                                        @endif
                                                        {{-- @foreach ($all as $key => $resep)
                                                                {{ $resep }},
                                                            @endforeach --}}
                                                    </td>
                                                    @if ($item->rujuk != null)
        ...
        <script>
         ...
         <script>
            document.getElementById('btnExportExcel').addEventListener('click', function () {
                ...
                let url = `/pasien-umum/export-excel?search=${search}&filter_option=${filterOption}&tanggal=${tanggal}&month=${month}&tahun=${tahun}`;
