        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="title">
                        <h5><strong>Laporan Kunjungan KB</strong></h5>
                    </div>
                                ...
                                <table id="example" class="table mt-2 mb-2 table-striped table-bordered"
                                    ...
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th class="custom-th">NAMA AKSEPTOR</th>
                                            <th class="custom-th">NAMA SUAMI</th>
                                            <th class="custom-th">UMUR</th>
                                            <th class="custom-th">JENIS KB</th>
                                            <th class="custom-th">TANGGAL PELAYANAN</th>
                                            <th class="custom-th">TANGGAL KEMBALI</th>
                                            <th class="custom-th">EDUKASI</th>
                                            <th class="custom-th">PETUGAS</th>
