<x-admin.layout.terminal title="Admin | Daftar 30 Diagnosa Terbanyak">
                        ...
                        <div class="col-5">
                            <div class="card" style="width: 100%; margin-bottom: 20px">
                                <div class="card-body">
                                    ...
                                    <p style="font-size: 14px; margin-bottom: -10px"><span style="color: red">*
                                        </span>Pilih
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                    href="{{ url('/export-diagnosa-excel') }}">Export
                                                    to Excel</a>
                                                <a class="dropdown-item"
                                                    href="{{ url('/export-diagnoses-pdf') }}">Export to
                                                    PDF</a>
