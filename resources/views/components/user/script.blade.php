...
<!-- Bootstrap JS -->
<script src="{{ asset('aset/js/bootstrap/bootstrap.bundle.js') }}"></script>
{{-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script> --}}

<!-- Tambahkan GLightbox sebelum main.js -->
<script src="{{ asset('aset/js/glightbox/glightbox.min.js') }}"></script>
<script src="{{ asset('aset/js/purecounter/purecounter_vanilla.js') }}"></script>
<script src="{{ asset('aset/js/aos/aos.js') }}"></script>
