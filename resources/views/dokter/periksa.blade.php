<x-admin.layout.terminal title="Dokter | Rekap Pasien">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="{{ route('dokter.periksa') }}" class="row g-3 mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 d-flex gap-2">
                                ...
                                <a href="{{ route('dokter.periksa') }}" class="btn btn-secondary w-100">
                        ...
                        <div class="isian" style="overflow-x: scroll">
                            ...
                            <div class="pagination mt-3 d-flex justify-content-end">
                                {{ $antrianDokter->appends(request()->input())->onEachSide(1)->links() }}
                            </div>
                        </div>
                    </div>
                </div>
