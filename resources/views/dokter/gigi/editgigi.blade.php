<!-- modal pemeriksaan -->
@if ($fisik)
    <div class="modal fade" id="editFisik{{ $fisik->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ url('dokter/edit-fisik/' . $fisik->id) }}" method="POST"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 4px;">
                                                            <input type="text" name="alergi_gigi" id="alergi_gigi"
                                                                class="form-control" value="{{ $fisik->alergi_gigi }}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 4px;">
                                                            <input type="text" name="a_riwayat_penggunaan_obat"
                                                                ...
                                                                value="{{ $fisik->a_riwayat_penggunaan_obat }}"
                                        ...
                                        <div class="col-md-12 mt-4">
                                            ...
                                            <div class="form-group">
                                                <textarea name="periksa_fisik" id="periksa_fisik" class="form-control mt-2 mb-2" cols="4" rows="5">{{ $fisik->periksa_fisik }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="tambahGigi-container">
                                                ...
                                                <select name="no_gigi[]" id="no_gigi"
                                                    ...
                                                    @for ($i = 1; $i <= 85; $i++)
                                                        <option value="{{ $i }}"
                                                            {{ in_array((string) $i, $selectedNoGigi) ? 'selected' : '' }}>
                                                            {{ $i }}
                                                        </option>
                                                    @endfor
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mt-2 mb-2 select2" name="keadaan_gigi[]"
                                                    ...
                                                    @endphp
                                                    @foreach (['SOU', 'NVT', 'NON', 'UNE', 'PRE', 'ANO', 'CFR', 'RRX', 'MIS', 'IMV', 'DIA', 'ATT', 'ABR', 'CAR'] as $keadaan)
                                                        <option value="{{ $keadaan }}"
                                                            {{ in_array($keadaan, $selectedKeadaanGigi) ? 'selected' : '' }}>
                                                            {{ $keadaan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control mt-2 mb-2" name="keterangan_gigi" cols="10" rows="5">{{ $fisik->keterangan_gigi }}</textarea>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control mt-2 mb-2"
                                                    ...
                                                    value="{{ $fisik->tindakan }}" placeholder="Tindakan">
                                            </div>
                                        </div>
                                        {{-- PROSEDURE TINDAKAN --}}
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control mt-2 mb-2"
                                                    ...
                                                    value="{{ $fisik->lama_tindakan }}" placeholder="Lama Tindakan">
                                            </div>
                                        </div>
                                        {{-- HASIL --}}
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control mt-2 mb-2"
                                                    ...
                                                    value="{{ $fisik->komplikasi_tindakan }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="alasan-preventif" style="display: none; margin-top: 8px;">
                                                    ...
                                                    <input type="text" id="jenis_pelayanan_preventif_alasan"
                                                        ...
                                                        value="{{ $fisik && $fisik->jenis_pelayanan_preventif_alasan ?? '-' }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="alasan-paliatif" style="display: none; margin-top: 8px;">
                                                    ...
                                                    <input type="text" id="jenis_pelayanan_paliatif_alasan"
                                                        ...
                                                        value="{{ $fisik && $fisik->jenis_pelayanan_paliatif_alasan ?? '-' }}"
                                                        class="form-control" placeholder="........" value="">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="alasan-kuratif" style="display: none; margin-top: 8px;">
                                                    ...
                                                    <input type="text" id="jenis_pelayanan_kuratif_alasan"
                                                        ...
                                                        value="{{ $fisik && $fisik->jenis_pelayanan_kuratif_alasan ?? '-' }}"
                                                        placeholder="........" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="alasan-rehabilitatif"
                                                    ...
                                                    <input type="text" id="jenis_pelayanan_rehabilitatif_alasan"
                                                        ...
                                                        value="{{ $fisik && $fisik->jenis_pelayanan_rehabilitatif_alasan ?? '-' }}"
                                                        class="form-control" placeholder="........" value="">
                                                </div>
                                            </div>
                                        </div>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @if ($fisik && $fisik->no_gigi)
                var selectedNoGigi = @json($selectedNoGigi);
            ...
            @if ($fisik && $fisik->keadaan_gigi)
                var selectedKeadaanGigi = @json($selectedKeadaanGigi);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if ($fisik)
                ...
                checkboxes.forEach(item => {
                    ...
                    if ('{{ $fisik->jenis_pelayanan_preventif }}' === item.value ||
                        '{{ $fisik->jenis_pelayanan_paliatif }}' === item.value ||
                        '{{ $fisik->jenis_pelayanan_kuratif }}' === item.value ||
                        '{{ $fisik->jenis_pelayanan_rehabilitatif }}' === item.value) {
