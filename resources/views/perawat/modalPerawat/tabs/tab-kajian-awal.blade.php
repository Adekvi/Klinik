        ...
        <div id="p_anak_riwayat_lahir">
            ...
            <div class="form-group mb-2 mt-2">
                <label for="p_anak_riwayat_lahir_cukup_bulan">
                    <input type="radio" name="p_anak_riwayat_lahir_cukup_bulan" id="p_anak_riwayat_lahir_cukup_bulan"
                        value="Cukup-bulan" style="transform: scale(1.5); margin-right: 10px">Cukup Bulan
                </label>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" wire:model="p_anak_riwayat_lahir_bb" class="form-control mt-2 mb-2">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" wire:model="p_anak_riwayat_lahir_pb" class="form-control mt-2 mb-2">
                        <div class="input-group-append mb-2 mt-2">
                            <span class="input-group-text" id="basic-addon2" style="background: rgb(228, 228, 228)">
                                <b>cm</b>
                            </span>
    ...
    <div class="asesmen-keperawatan">
            ...
            <div class="col-lg-12 mb-2">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" wire:model.live="nutrisi_bb" class="form-control mt-2 mb-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" wire:model.live="nutrisi_tb" class="form-control mt-2 mb-2">
                            <div class="input-group-append">
                                <span class="input-group-text mb-2 mt-2" id="basic-addon2"
                                    style="background: rgb(228, 228, 228)">
                                    <b>cm</b>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="text" wire:model="nutrisi_imt" class="form-control mt-2 mb-2" readonly>
                            <div class="input-group-append">
                                <span class="input-group-text mb-2 mt-2" id="basic-addon2"
                                    style="background: rgb(228, 228, 228)">
                                    <b>kg/m2</b>
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="ak_jenisaktivitas_toileting" id="ak_jenisaktivitas_mobilisasi"
                        class="form-control mt-2 mb-2 ">
                ...
                <div class="col-md-6">
                    <select name="ak_jenisaktivitas_makan_minum" id="ak_jenisaktivitas_mobilisasi"
                        class="form-control mt-2 mb-2 ">
                ...
                <div class="col-md-6">
                    <select name="ak_jenisaktivitas_mandi" id="ak_jenisaktivitas_mobilisasi"
                        class="form-control mt-2 mb-2 ">
        ...
        <div class="form-group mt-3">
            ...
            <div class="form-group mb-2 mt-2">
                <label for="ak_resiko_jatuh_rendah">
                    <input type="radio" name="ak_resiko_jatuh_rendah" id="ak_resiko_jatuh_rendah" value="Rendah"
                        style="transform: scale(1.5); margin-right: 10px" checked> Rendah
                </label>
                <label for="ak_resiko_jatuh_sedang">
                    <input type="radio" name="ak_resiko_jatuh_sedang" id="ak_resiko_jatuh_sedang" value="Sedang"
                        style="transform: scale(1.5); margin-right: 10px; margin-left: 30px">
                    Sedang
                </label>
                <label for="ak_resiko_jatuh_tinggi">
                    <input type="radio" name="ak_resiko_jatuh_tinggi" id="ak_resiko_jatuh_tinggi" value="Tinggi"
                        style="transform: scale(1.5); margin-right: 10px; margin-left: 30px">
                    Tinggi
                </label>
            </div>
