            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="a_riwayat_alergi" id="a_riwayat_alergi" class="form-control mt-2 mb-2 ">
                        <option value="{{ $booking->rm->a_riwayat_penyakit_skrg ?? 'Tidak Ada' }}" selected>
                            {{ $booking->rm->a_riwayat_alergi ?? 'Tidak Ada' }}</option>
    ...
    <div class="tanda-vital">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="text" wire:model.defer="p_tensi" class="form-control mt-2 mb-2">
            ...
            <div class="col-md-4">
                <label>RR</label>
                <div class="input-group">
                    <input type="text" wire:model.defer="p_rr" class="form-control mt-2 mb-2">
        ...
        <div class="row">
            <div class="col-md-4">
                <label>Nadi</label>
                <div class="input-group">
                    <input type="text" wire:model.defer="p_nadi" class="form-control mt-2 mb-2">
                    <span class="input-group-text mb-2 mt-2"><b>/ minute</b></span>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <label>SpO2</label>
                <div class="input-group">
                    <input type="text" wire:model.defer="p_suhu" class="form-control mt-2 mb-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="number" wire:model.live="p_tb" class="form-control mt-2 mb-2">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="number" wire:model.live="p_bb" class="form-control mt-2 mb-2">
            ...
            <div class="col-md-4">
                <label>IMT</label>
                <div class="input-group">
                    <input type="text" wire:model="p_imt" class="form-control mt-2 mb-2" readonly>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="input-group d-flex mt-2">
                        <input type="number" wire:model.live="gcs_e" class="form-control" placeholder="E">
                        <input type="number" wire:model.live="gcs_m" class="form-control" placeholder="M">
                        <input type="number" wire:model.live="gcs_v" class="form-control" placeholder="V">
        ...
        <div class="row" style="text-align: start">
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-kepala_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-kepala_{{ $booking->id }}" name="alasan-kepala"
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-mata_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-mata_{{ $booking->id }}" name="alasan-mata"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-leher_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-leher_{{ $booking->id }}" name="alasan-leher"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-tht_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-tht_{{ $booking->id }}" name="alasan-tht"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-thorax_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-thorax_{{ $booking->id }}" name="alasan-thorax"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-paru_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-paru_{{ $booking->id }}" name="alasan-paru"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-jantung_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-jantung_{{ $booking->id }}" name="alasan-jantung"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-abdomen_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-abdomen_{{ $booking->id }}" name="alasan-abdomen"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group mt-2 mb-2">
                ...
                <div id="alasan-kulit_{{ $booking->id }}" style="display: none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="alasan-kulit_{{ $booking->id }}" name="alasan-kulit"
                                class="form-control mt-2 mb-2">
                        </div>
                    </div>
                </div>
