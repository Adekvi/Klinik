<x-admin.layout.terminal title="Perawat | Laporan Kunjungan Poli Umum">
                        ...
                        <div class="card-body">
                            ...
                            <form id="filterForm" method="GET" action="{{ route('perawat.laporan.poliUmum.umum') }}">
                                ...
                                <div class="button"
                                    ...
                                    <a href="{{ route('perawat.laporan.poliUmum.umum') }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mt-2 mb-2 table-striped table-bordered"
                                    ...
                                    <thead class="table-primary"
                                        ...
                                        <tr>
                                            <th class="custom-th" rowspan="17">NO.</th>
                                            <th class="custom-th" rowspan="17">TANGGAL</th>
                                            <th class="custom-th" rowspan="17">JAM</th>
                                            <th class="custom-th" rowspan="17">NO. RM</th>
                                            <th class="custom-th" rowspan="17">NAMA PASIEN</th>
                                            <th class="custom-th" rowspan="17">JENIS PASIEN</th>
                                            <th class="custom-th" rowspan="17">TANGGAL LAHIR</th>
                                            <th class="custom-th" rowspan="17">PASIEN UMUM</th>
                                            <th class="custom-th" rowspan="17">HARGA</th>
                                            <th class="custom-th" rowspan="17">NOMOR NIK</th>
                                            <th class="custom-th" rowspan="17">NOMOR HP</th>
                                            <th class="custom-th" rowspan="17">PEKERJAAN</th>
                                    ...
                                    <tbody class="text-center" style="text-transform: uppercase">
                                        ...
                                        @else
                                            @foreach ($umumUmum as $index => $item)
                                                @if ($item->pasien->jenis_pasien == 'Umum')
                                                    {{-- @php
                                                        $pasienId = $item->pasien->id;
                                                    ...
                                                    @endphp --}}
                                                    <tr>
                                                        <td>{{ $umumUmum->firstItem() + $index }}</td>
                            ...
                            <div class="halaman d-flex justify-content-end">
                                {{ $umumUmum->appends(request()->only(['search', 'entries', 'filter_option', 'tanggal', 'month', 'tahun']))->links() }}
                            </div>
                        </div>
                    </div>
                </div>
