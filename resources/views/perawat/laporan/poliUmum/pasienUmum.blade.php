                            ...
                            <div class="button" style="display: flex; align-items: baseline">
                                ...
                                <div class="dropdown" style="margin-left: 10px">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ url('export/pasienUmum-Umum') }}">Export to
                                            Excel</a>
                                            ...
                                            @if ($item->pasien->jenis_pasien == 'Umum')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Td : {{ $item->p_tensi }} mmHg, <br> N : {{ $item->p_nadi }} x/m,
                                                        ...
                                                        <br> SpO2 : {{ $item->spo2 }}, <br> BB : {{ $item->p_bb }} kg,
                                                        <br> TB : {{ $item->p_tb }} cm
                                                    </td>
                                                    @php
