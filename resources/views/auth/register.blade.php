...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Assistant:wght@500&family=Playfair+Display&display=swap" rel="stylesheet">
</head>
<style>
    .btn-login {
    ...
    <div class="container">
      <div class="row page-login d-flex align-items-center">
        <div class="section-left col-12 col-md-6">
          ...
          font-family: cursive; font-weight: bold;">Silahkan Registrasi Terlebih Dahulu <br> Untuk Melanjutkan Pendaftaran</h2>
            <img src="{{ asset('assets/img/gambar-dokter.png') }}" alt="" class="d-none d-sm-flex" style="    width: 65%;">
        </div>
        <div class="section-right col-12 col-md-4">
          <div class="card mt-4 mb-4">
            <div class="card-body">
              <div class="text-center">
                <img src="{{ asset('assets/img/logo_cv.png') }}" alt=""
                style="width: 50%;" class="mb-4">
              ...
              <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <div onclick="toggleConfirmPassword()" style="position: absolute; top: 57%; right: 4%;">
                        <svg width="20" height="14" viewBox="0 0 20 14"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
