<div class="modal fade" id="poto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/master/margin-tambah')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/margin/tambah.blade.php ENDPATH**/ ?>