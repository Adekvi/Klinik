<?php $__env->startSection('title', 'Asesmen'); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex" style="gap: 5px">
                            <div class="kembali">
                                <a href="<?php echo e(url('dokter/index')); ?>" class="btn btn-outline-primary" data-toggle="tooltip"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="riwayatDropdown">
                                    ...
                                    <?php elseif($antrianDokter->poli->namapoli === 'Gigi'): ?>
                                        ...
                                        <li>
                                            <?php if($fisik && $fisik->id): ?>
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                    data-bs-target="#riwayatGigi<?php echo e($fisik->id); ?>">Riwayat Odontogram</a>
                                            <?php else: ?>
                            ...
                            <table class="table" style="width: 50%; border-collapse: separate">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 4px; width: 10px;">:</td>
                                        <td style="padding: 4px;"><?php echo e($antrianDokter->booking->pasien->nama_pasien); ?></td>
                                    </tr>
                                    <tr>
                                        <th scope="row" style="padding: 4px; text-align: left;">Jenis Pasien</th>
                                        <td style="padding: 4px; width: 10px;">:</td>
                                        <td style="padding: 4px;"><?php echo e($antrianDokter->booking->pasien->jenis_pasien); ?></td>
                                    </tr>
                                    <tr>
                                                    ...
                                                    <?php if($soapTerbaru): ?>
                                                        <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            <button type="button" class="btn text-primary"
                                                                ...
                                                                data-bs-target="#editSoap<?php echo e($soapTerbaru->id); ?>">
                                                                <i class="fas fa-pen"></i>
                                                            </button>
                                                        </span>
                                                    <?php endif; ?>
                                                    <?php if($fisik && $fisik->dokter && $fisik->dokter->poli): ?>
    ...
    <?php echo $__env->make('dokter.modal.editSoap', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layout.dasbrod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/dokter/soap.blade.php ENDPATH**/ ?>