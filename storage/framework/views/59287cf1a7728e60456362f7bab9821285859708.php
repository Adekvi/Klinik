...
<?php $__env->startSection('title', 'Admin | Data Semua Pasien'); ?>
                        ...
                        <form method="GET" action="<?php echo e(route('master.semuadata')); ?>"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <select name="recent_entries" id="recent_entries" class="form-select form-select-sm me-3"
                                    ...
                                    <option value="10" <?php echo e(request('recent_entries', 10) == 10 ? 'selected' : ''); ?>>10
                                    </option>
                                    ...
                                    <option value="100" <?php echo e(request('recent_entries') == 100 ? 'selected' : ''); ?>>100
                                    </option>
                                </select>
                            </div>

                            <div class="d-flex align-items-center">
                                <input type="text" name="recent_search" value="<?php echo e(request('recent_search')); ?>"
                                ...
                                <tbody class="text-center">
                                    <?php $__currentLoopData = $recentPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(!empty($record->nama_pasien) ? $record->nama_pasien : '-'); ?></td>
                                            ...
                                            <td><?php echo e(!empty($record->pekerjaan) ? $record->pekerjaan : '-'); ?></td>
                                            <td><?php echo e(!empty($record->alamat_asal) ? $record->alamat_asal : '-'); ?></td>
                                            <td><?php echo e(!empty($record->noHP) ? $record->noHP : '-'); ?></td>
                                            <td><?php echo e(!empty($record->jenis_pasien) ? $record->jenis_pasien : '-'); ?></td>
...
<?php echo $__env->make('admin.layout.dasbrod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/semuapasien/index.blade.php ENDPATH**/ ?>