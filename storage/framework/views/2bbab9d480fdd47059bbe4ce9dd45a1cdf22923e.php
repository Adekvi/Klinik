...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Admin | Data Anjuran Obat']); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <div class="pasien-bpjs">
                    <div class="card-title">
                        <div class="judul d-flex justify-content-between align-items-center">
                            <h4><strong>Data Anjuran Obat</strong></h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tb-umum">
                                ...
                                <table class="table table-striped table-responsive"
                                    ...
                                    <tbody>
                                        <?php if(count($anjuran) == 0): ?>
                                            <tr>
                                                <td class="text-center" colspan="5">Tidak ada data</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $anjuran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($anjuran->firstItem() + $index); ?></td>
                                                    <td><?php echo e($item->kode_anjuran); ?></td>
                                                    <td><?php echo e($item->golongan ?? '-'); ?></td>
                                                    <td>
                                                        <form method="POST" action="<?php echo e(url('updateStatus-anjuran')); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="status-toggle">
                                                                ...
                                                                <span
                                                                    class="status-text <?php echo e($item->status ? 'active' : 'inactive'); ?>">
                            ...
                            <div class="halaman mt-2 d-flex justify-content-end mt-2">
                                <?php echo e($anjuran->appends(request()->only(['search', 'entries']))->links()); ?>
    ...
    <?php echo $__env->make('admin.master.dataanjuran.tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.dataanjuran.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.dataanjuran.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/dataanjuran/index.blade.php ENDPATH**/ ?>