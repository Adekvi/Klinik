<?php $__env->startSection('title', 'Apoteker'); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-responsive" style="white-space: nowrap;">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <?php else: ?>
                                        <?php $allSoapPatients = []; ?>
                                        <?php $__currentLoopData = $antrianObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                        ...
                                        <?php $__currentLoopData = $antrianObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="row_<?php echo e($item->id); ?>">
                                                <td><?php echo e($loop->iteration + ($antrianObat->currentPage() - 1) * $antrianObat->perPage()); ?>
                                                ...
                                                <td>
                                                    <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        <button data-nomor-antrian-obat="<?php echo e($item->kode_antrian); ?>"
                                                    ...
                                                    <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#tambahObat<?php echo e($item->id); ?>">
                        ...
                        <div class="d-flex justify-content-center mt-3 mb-3">
                            <?php echo e($antrianObat->links()); ?> <!-- Laravel's built-in pagination links -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php $__currentLoopData = $antrianObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('obat.ModalTambahResep.ModalResep', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <script>
            // cetak kartu
            function printCard() {
                // Ambil ID dari data-id pada button atau dari variabel JavaScript lainnya
                const id = '<?php echo e($item->id); ?>'; // Pastikan $item->id tersedia di view
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?php echo e(url('obat/lewati/' . $item->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layout.dasbrod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/obat/index.blade.php ENDPATH**/ ?>