                            ...
                            <div class="ms-4 mt-3">
                                ...
                                <div>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" name="hs_hpht" wire:model="hpht" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="hs_usia_kehamilan" class="form-control" wire:model="usia_kehamilan"
                        ...
                        <div class="mt-4">
                            ...
                            <div class="ms-4 mt-3">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="hs_imunisasi_tt" id=""
                                            class="form-control mt-2 mb-2">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ps-4">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <input type="text" class="form-control me-2" name="obj_tb" style="width: 200px;">
                                    <span>cm</span>
                                </div>
                            </div>
                        </div>
