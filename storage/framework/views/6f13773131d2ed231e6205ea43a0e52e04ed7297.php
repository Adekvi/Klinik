                 ...
                 <div class="modal-body">
                                 ...
                                 <div class="card-body p-3"
                                     ...
                                     <div class="mb-3 d-flex">
                                         ...
                                         <div class="text-capitalize fw-semibold">
                                             <?php echo e(strtolower($item->booking->pasien->nama_pasien)); ?>

                                             (<?php echo e($item->booking->pasien->jekel); ?>)
                                         </div>
                                     </div>
                                     <div class="mb-3 d-flex">
                                     ...
                                     <div class="mb-3 d-flex">
                                         ...
                                         <span class="me-1" style="width: 30px;">:</span>
                                         <div class="text-capitalize fw-semibold">
                                             <?php echo e($item->booking->pasien->jenis_pasien); ?>
                     ...
                     <div class="periksa d-flex justify-content-between align-items-start">
                         ...
                         <div class="d-flex gap-2">
                             ...
                             <button type="button" class="btn btn-outline-secondary" id="btnHamil<?php echo e($item->id); ?>">
                                 Hamil
                             </button>
                             ...
                             <div class="row" style="text-align: start">
                                 ...
                                 <div class="form-group mt-2 mb-2">
                                     ...
                                     <div id="alasan-tht_<?php echo e($item->id); ?>" style="display: none;">
                                         <input type="text" id="alasan-tht_<?php echo e($item->id); ?>" name="alasan-tht"
                                             class="form-control mt-2 mb-2">
                                     </div>
                                 </div>
                                 <div class="form-group mt-2 mb-2">
 ...
 <?php $__env->startPush('script'); ?>
     <script>
         ...
         //  modal kedua
         document.addEventListener("DOMContentLoaded", function() {
             const btn = document.getElementById("btnHamil<?php echo e($item->id); ?>");
             const modal2 = document.getElementById("modalHamil<?php echo e($item->id); ?>");
             const modal1 = document.getElementById("periksa<?php echo e($item->id); ?>");
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\Klinik\resources\views/perawat/modalPerawat/ModalAnamnesis.blade.php ENDPATH**/ ?>