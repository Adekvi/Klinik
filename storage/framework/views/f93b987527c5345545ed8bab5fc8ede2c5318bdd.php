...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Perawat | Laporan Kunjungan Poli Umum']); ?>
                ...
                <div class="pasien-bpjs">
                    ...
                    <div class="card mb-4" style="width: 40%">
                        <div class="card-body">
                            ...
                            <form id="filterForm" method="GET" action="<?php echo e(route('perawat.laporan.poliUmum.bpjs')); ?>">
                                ...
                                <div class="button"
                                    ...
                                    <a href="<?php echo e(route('perawat.laporan.poliUmum.bpjs')); ?>"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('export-pasienBpjs-Umum', request()->query())); ?>">Export
                                                to
                                                Excel</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mt-2 mb-2 table-striped table-bordered"
                                    ...
                                    <tbody class="text-center" style="text-transform: uppercase">
                                        ...
                                        <?php if(count($umumBpjs) === 0): ?>
                                            <tr>
                                                <td colspan="18" style="text-align: center">Tidak Ada Data</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $umumBpjs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($item->pasien->jenis_pasien == 'Bpjs'): ?>
                                                    
                                                    <tr>
                                                        <td><?php echo e($umumBpjs->firstItem() + $index); ?></td>
                                                        <td><?php echo e(date('d-m-Y', strtotime($item->created_at))); ?></td>
                                                        <td><?php echo e(date('H:i', strtotime($item->created_at))); ?></td>
                                                        <td><?php echo e($item->pasien->no_rm); ?></td>
                                                        <td><?php echo e($item->pasien->nama_pasien); ?></td>
                                                        <td><?php echo e($item->pasien->status); ?></td>
                                                        <td><?php echo e(date('d-m-Y', strtotime($item->pasien->tgllahir))); ?>
                                                        ...
                                                        <td><?php echo e($item->p_tensi); ?> mmHg</td>
                                                        <td><?php echo e($item->p_nadi); ?> x/m</td>
                                                        <td><?php echo e($item->p_rr); ?> x/m</td>
                                                        <td><?php echo e($item->p_suhu); ?> C</td>
                                                        <td><?php echo e($item->spo2); ?> %</td>
                                                        <td><?php echo e($item->p_bb); ?> Kg</td>
                                                        <td><?php echo e($item->p_tb); ?> Cm</td>
                                                        <td><?php echo e($item->kd_diagno); ?></td>
                                                        <td class="text-start"><?php echo e($item->nm_diagno); ?></td>
                                                        <td class="text-start">
                                                            <?php
                            ...
                            <div class="halaman d-flex justify-content-end">
                                <?php echo e($umumBpjs->appends(request()->only(['search', 'entries', 'filter_option', 'tanggal', 'month', 'tahun']))->links()); ?>
    ...
    <?php $__env->startPush('script'); ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                var filterOption = '<?php echo e($filterOption ?? ''); ?>';
                if (filterOption === 'full_date') {
                    $('#filter_by_full_date').prop('checked', true);
                    $('#tanggal').prop('disabled', false);
                    $('#tanggal').val('<?php echo e($tanggal ?? ''); ?>');
                    $('.month_year select').prop('disabled', true);
                } else if (filterOption === 'month_year') {
                    $('#filter_by_month_year').prop('checked', true);
                    $('#tanggal').prop('disabled', true);
                    $('.month_year select').prop('disabled', false);
                    var monthValue = '<?php echo e($month ?? ''); ?>';
                    var yearValue = '<?php echo e($tahun ?? ''); ?>';
                    if (monthValue) {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Klinik\resources\views/perawat/laporan/poliUmum/bpjs/pasienBpjs.blade.php ENDPATH**/ ?>