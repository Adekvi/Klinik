...
<body onload="window.print(); setTimeout(() => { window.close(); }, 1000);">
    <section class="antrian">
        <div class="container">
            ...
            <div class="middle">
                <h3>No. RM: <?php echo e($antrian->booking->no_rm); ?></h3>
                <div class="antrian-number"><?php echo e($antrian->kode_antrian); ?></div>
                <h3>Poli <?php echo e($antrian->poli->namapoli); ?></h3>
            </div>
            <div class="bottom">
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/pasien/bukti-daftar.blade.php ENDPATH**/ ?>