<div class="modal fade" id="poto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('apoteker/master-obat/jenis-tambah')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Klinik\resources\views/obat/master/jenisobat/tambah.blade.php ENDPATH**/ ?>