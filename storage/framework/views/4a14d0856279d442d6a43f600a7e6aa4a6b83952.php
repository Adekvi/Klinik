    ...
    <div class="modal fade" id="hapuspoli<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/master/aturan-hapus/' . $item->id)); ?>" method="POST"
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/dataaturan/hapus.blade.php ENDPATH**/ ?>