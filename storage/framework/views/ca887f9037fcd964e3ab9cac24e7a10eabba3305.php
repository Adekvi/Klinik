<?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="edituser<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <form action="<?php echo e(url('admin/edit/user/' . $item->id)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2 mb-2" name="name" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control mt-2 mb-2" name="email" id="email"
...
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/user/edit/modaleditPasien.blade.php ENDPATH**/ ?>