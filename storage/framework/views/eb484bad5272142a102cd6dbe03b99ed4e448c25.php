...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Apoteker | Data Pasien']); ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('apoteker.pasien-dapat-obat')); ?>" class="row g-3 mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('apoteker.pasien-dapat-obat')); ?>" class="btn btn-secondary w-100">
                        ...
                        <div class="isian" style="overflow-x: scroll">
                            <table class="table table-striped table-bordered text-center"
                                ...
                                <tbody style="text-transform: uppercase">
                                    <?php if(count($pasienObat) === 0): ?>
                                        <tr>
                                            <td colspan="12" style="text-align: center">Tidak Ada Data Pasien</td>
                                        </tr>
                                    <?php else: ?>
                                        <?php $__currentLoopData = $pasienObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item->status == 'S'): ?>
                                                <tr id="row_<?php echo e($item->id); ?>">
                                                    <td><?php echo e($loop->iteration + ($pasienObat->currentPage() - 1) * $pasienObat->perPage()); ?>
                                                    ...
                                                    <td class="text-center">
                                                        <?php echo e($item->booking->pasien->domisili ?: '-'); ?></td>
                                                    <td class="text-center">
                                                        <?php echo e($item->booking->pasien->jenis_pasien ?: '-'); ?></td>
                                                    <td>
                        ...
                        <div class="pagination mt-2 d-flex justify-content-end">
                            <?php echo e($pasienObat->appends(request()->input())->onEachSide(1)->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Klinik\resources\views/obat/rekap-pasien.blade.php ENDPATH**/ ?>