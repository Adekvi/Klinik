...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Admin | Data Jenis Obat']); ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tb-umum">
                                ...
                                <table class="table table-striped table-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($jenis->firstItem() + $index); ?></td>
                                                    <td><?php echo e($item->jenis); ?></td>
                                                    <td><?php echo e($item->golongan ?? '-'); ?></td>
                                                    <td><?php echo e($item->keterangan ?? '-'); ?></td>
                                                    <td>
                                                        <form method="POST" action="<?php echo e(url('updateStatus-jenis')); ?>">
                                                            <?php echo csrf_field(); ?>
                            ...
                            <div class="halaman mt-2 d-flex justify-content-end mt-2">
                                <?php echo e($jenis->appends(request()->only(['search', 'entries']))->links()); ?>
    ...
    <?php echo $__env->make('admin.master.datajenis.tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.datajenis.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.datajenis.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/datajenis/index.blade.php ENDPATH**/ ?>