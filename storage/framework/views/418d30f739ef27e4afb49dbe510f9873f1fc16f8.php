<?php $__currentLoopData = $pasien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="editbpjs<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/edit/pasienbpjs/' . $item->id)); ?>" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-2 mb-2" name="bpjs"
                                        id="bpjs" value="<?php echo e($item->bpjs); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/pasienbpjs/modaledit.blade.php ENDPATH**/ ?>