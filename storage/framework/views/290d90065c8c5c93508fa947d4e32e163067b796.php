...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Admin | Rekap Pemeriksaan Laborat']); ?>
        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="title">
                        <h5><strong>Laporan Pemeriksaan Laborat</strong></h5>
                    </div>
                                ...
                                <table id="example" class="table mt-2 mb-2 table-striped table-bordered"
                                    ...
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th
                                                style="text-align: center; vertical-align: middle; white-space: nowrap; width: auto">
                                                JENIS PEMERIKSAAN (BPJS)</th>
                                            <th
                                                style="text-align: center; vertical-align: middle; white-space: nowrap; width: auto">
                                                JENIS PEMERIKSAAN (UMUM)</th>
                                            <th
                                                style="text-align: center; vertical-align: middle; white-space: nowrap; width: auto">
                                                HARGA PEMERIKSAAN UMUM</th>
                                            <th
                                                style="text-align: center; vertical-align: middle; white-space: nowrap; width: auto">
                                                AKSI</th>
                                        </tr>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                btnSearch.addEventListener('click', function() {
                    ...
                    fetch('/rekapan/pemeriksaan-lab/search', {
                            method: 'POST',
                            headers: {
                ...
                function cetakHasilFilter() {
                    ...
                    fetch('/rekapan/pemeriksaan-lab/cetak', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/rekapan/pemeriksaan/pemeriksaan-lab/index.blade.php ENDPATH**/ ?>