    ...
    <div class="modal fade" id="hapuspoli<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('apoteker/master-obat/aturan-hapus/' . $item->id)); ?>" method="POST"
...
<?php /**PATH C:\xampp\htdocs\Klinik\resources\views/obat/master/aturanMinum/hapus.blade.php ENDPATH**/ ?>