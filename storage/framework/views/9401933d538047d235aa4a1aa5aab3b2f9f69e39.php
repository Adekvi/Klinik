<div class="modal fade" id="poto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/tambah/master-ttd')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/ttdMedis/modaltambah.blade.php ENDPATH**/ ?>