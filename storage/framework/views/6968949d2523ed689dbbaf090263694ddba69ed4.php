...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Admin | Data User']); ?>
...
<?php $component->withAttributes([]); ?>
                                                        ...
                                                        <td>
                                                            <div class="aksi d-flex">
                                                                <button class="btn btn-primary"
                                                                    data-bs-target="#editperawat<?php echo e($item->id); ?>"
                                                                    data-bs-toggle="modal"><i class="fas fa-pen"></i>
                                                                    Edit</button>
                                                                <button type="button" class="btn btn-danger mx-2"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#hapususer<?php echo e($item->id); ?>"><i
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="table table-striped table-bordered mt-2 mb-2"
                                        ...
                                        <tbody>
                                            <?php $counter = 1 ?>
                                            <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($item->role === 'dokter'): ?>
                                                    <tr>
                                                        <td><?php echo e($counter++); ?></td>
                                                        <td><?php echo e($item->name); ?></td>
                                                        <td><?php echo e($item->username); ?></td>
                                                        <td><?php echo e($item->password); ?></td>
                                                        <td><?php echo e($item->dokter->profesi); ?></td>
                                                        <td>
                                                            <div class="aksi d-flex">
                                                                <button class="btn btn-primary"
                                                                    data-bs-target="#editperawat<?php echo e($item->id); ?>"
    ...
    <?php echo $__env->make('admin.master.user.modalTambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.user.edit.modaleditPasien', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.user.edit.modaleditPerawat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.master.user.modalhapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/user/index.blade.php ENDPATH**/ ?>