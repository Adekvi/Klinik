    ...
    <div class="modal fade" id="hapusbpjs<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/tambah/pasienbpjs/' . $item->id)); ?>" method="POST"
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/pasienbpjs/modalhapus.blade.php ENDPATH**/ ?>