<div class="modal fade" id="tambahuser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/tambah/user')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/user/modalTambah.blade.php ENDPATH**/ ?>