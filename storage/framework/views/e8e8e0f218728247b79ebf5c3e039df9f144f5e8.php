                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <td>
                                                <div class="obat-container" data-pasien-id="<?php echo e($item->id); ?>">
                                                    ...
                                                    <?php if(!empty($semuaObat) && !empty($olehNgombe)): ?>
                                            ...
                                            <td>
                                                <div class="minum-container">
                                                    <?php if(!empty($allMinumAturan)): ?>
                                                        <?php $__currentLoopData = $allMinumAturan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $minum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="form-group minum-row">
                                                                <div class="input-group d-flex align-items-center">
                                                                    <!-- Dropdown untuk frekuensi minum -->
                                                                    <select name="obat_Ro[<?php echo e($index); ?>][sehari]"
                                                                        id="sehari_<?php echo e($item->id); ?>_<?php echo e($index); ?>"
                                                                        class="form-control sehari-select"
                                                                        aria-label="Pilih frekuensi minum"
                                                                        onchange="toggleInput(this, '<?php echo e($item->id); ?>_<?php echo e($index); ?>')">
                                                                        <option value="1x1 SENDOK"
                                                                            <?php echo e($minum == '1x1 SENDOK' ? 'selected' : ''); ?>>
                                                                            1x1 SENDOK</option>
                                                                        <option value="1x1/2 SENDOK"
                                                                            <?php echo e($minum == '1x1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            1x1/2 SENDOK</option>
                                                                        <option value="1x3/4 SENDOK"
                                                                            <?php echo e($minum == '1x3/4 SENDOK' ? 'selected' : ''); ?>>
                                                                            1x3/4 SENDOK</option>
                                                                        <option value="1x1 1/2 SENDOK"
                                                                            <?php echo e($minum == '1x1 1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            1x1 1/2 SENDOK</option>
                                                                        <option value="2x1 SENDOK"
                                                                            <?php echo e($minum == '2x1 SENDOK' ? 'selected' : ''); ?>>
                                                                            2x1 SENDOK</option>
                                                                        <option value="2x1/2 SENDOK"
                                                                            <?php echo e($minum == '2x1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            2x1/2 SENDOK</option>
                                                                        <option value="2x3/4 SENDOK"
                                                                            <?php echo e($minum == '2x3/4 SENDOK' ? 'selected' : ''); ?>>
                                                                            2x3/4 SENDOK</option>
                                                                        <option value="3x1 SENDOK"
                                                                            <?php echo e($minum == '3x1 SENDOK' ? 'selected' : ''); ?>>
                                                                            3x1 SENDOK</option>
                                                                        <option value="3x1/2 SENDOK"
                                                                            <?php echo e($minum == '3x1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            3x1/2 SENDOK</option>
                                                                        <option value="3x3/4 SENDOK"
                                                                            <?php echo e($minum == '3x3/4 SENDOK' ? 'selected' : ''); ?>>
                                                                            3x3/4 SENDOK</option>
                                                                        <option value="3x1 1/2 SENDOK"
                                                                            <?php echo e($minum == '3x1 1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            3x1 1/2 SENDOK</option>
                                                                        <option value="4x1 SENDOK"
                                                                            <?php echo e($minum == '4x1 SENDOK' ? 'selected' : ''); ?>>
                                                                            4x1 SENDOK</option>
                                                                        <option value="4x1 1/2 SENDOK"
                                                                            <?php echo e($minum == '4x1 1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            4x1 1/2 SENDOK</option>
                                                                        <option value="4x1/2 SENDOK"
                                                                            <?php echo e($minum == '4x1/2 SENDOK' ? 'selected' : ''); ?>>
                                                                            4x1/2 SENDOK</option>
                                                                        <option value="4x3/4 SENDOK"
                                                                            <?php echo e($minum == '4x3/4 SENDOK' ? 'selected' : ''); ?>>
                                                                            4x3/4 SENDOK</option>
                                                                        <option value="3x SEHARI OLES TIPIS-TIPIS"
                                                                            <?php echo e($minum == '3x SEHARI OLES TIPIS-TIPIS' ? 'selected' : ''); ?>>
                                                                            3x SEHARI OLES TIPIS-TIPIS</option>
                                                                        <option value="2x SEHARI OLES TIPIS-TIPIS"
                                                                            <?php echo e($minum == '2x SEHARI OLES TIPIS-TIPIS' ? 'selected' : ''); ?>>
                                                                            2x SEHARI OLES TIPIS-TIPIS</option>
                                                                        <option value="1x1 TABLET"
                                                                            <?php echo e($minum == '1x1 TABLET' ? 'selected' : ''); ?>>
                                                                            1x1 TABLET</option>
                                                                        <option value="2x1 TABLET"
                                                                            <?php echo e($minum == '2x1 TABLET' ? 'selected' : ''); ?>>
                                                                            2x1 TABLET</option>
                                                                        <option value="3x1 TABLET"
                                                                            <?php echo e($minum == '3x1 TABLET' ? 'selected' : ''); ?>>
                                                                            3x1 TABLET</option>
                                                                        <option value="3x1 BUNGKUS"
                                                                            <?php echo e($minum == '3x1 BUNGKUS' ? 'selected' : ''); ?>>
                                                                            3x1 BUNGKUS</option>
                                                                        <option value="3x2 TETES"
                                                                            <?php echo e($minum == '3x2 TETES' ? 'selected' : ''); ?>>
                                                                            3x2 TETES</option>
                                                                        <option value="3x1 TETES"
                                                                            <?php echo e($minum == '3x1 TETES' ? 'selected' : ''); ?>>
                                                                            3x1 TETES</option>
                                                                        <option value="4x2 TETES"
                                                                            <?php echo e($minum == '4x2 TETES' ? 'selected' : ''); ?>>
                                                                            4x2 TETES</option>
                                                                        <option value="INJEKSI 1 ml"
                                                                            <?php echo e($minum == 'INJEKSI 1 ml' ? 'selected' : ''); ?>>
                                                                            INJEKSI 1 ml</option>
                                                                        <option value="INJEKSI 2 ml"
                                                                            <?php echo e($minum == 'INJEKSI 2 ml' ? 'selected' : ''); ?>>
                                                                            INJEKSI 2 ml</option>
                                                                        <option value="INJEKSI 3 ml"
                                                                            <?php echo e($minum == 'INJEKSI 3 ml' ? 'selected' : ''); ?>>
                                                                            INJEKSI 3 ml</option>
                                                                        <option value="NEBUL 1 ampul"
                                                                            <?php echo e($minum == 'NEBUL 1 ampul' ? 'selected' : ''); ?>>
                                                                            NEBUL 1 ampul</option>
                                                                        <option value="custom">Lainnya</option>
                                                                    </select>
                                                                    <!-- Input kustom untuk opsi "Lainnya" (awalnya disembunyikan) -->
                                                                    <input type="text"
                                                                        name="obat_Ro[<?php echo e($index); ?>][sehari]"
                                                                    ...
                                                                    <input type="text"
                                                                        name="obat_Ro[<?php echo e($index); ?>][aturan]"
                                                                        id="aturan_<?php echo e($item->id); ?>_<?php echo e($index); ?>"
                                            ...
                                            <td>
                                                <div class="jumlah-container" data-pasien-id="<?php echo e($item->id); ?>">
                                                    ...
                                                    ?>
                                                    <?php if(!empty($allJenisObat)): ?>
                                                        <?php $__currentLoopData = $allJenisObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                            ...
                                                            <div class="form-group jumlah-row">
                                                                <div class="jumlah-group">
                                                                    <select
                                                                        ...
                                                                        <option value="Tablet"
                                                                            <?php echo e($jenis == 'Tablet' ? 'selected' : ''); ?>>
                                                                            Tablet</option>
                                                                        <option value="Kapsul"
                                                                            <?php echo e($jenis == 'Kapsul' ? 'selected' : ''); ?>>
                                                                            Kapsul</option>
                                                                        <option value="Bungkus"
                                                                            <?php echo e($jenis == 'Bungkus' ? 'selected' : ''); ?>>
                                                                            Bungkus</option>
                                                                        <option value="Sirup"
                                                                            <?php echo e($jenis == 'Sirup' ? 'selected' : ''); ?>>
                                                                            Sirup</option>
                                                                        <option value="Salep"
                                                                            <?php echo e($jenis == 'Salep' ? 'selected' : ''); ?>>
                                                                            Salep</option>
                                                                        <option value="Krim"
                                                                            <?php echo e($jenis == 'Krim' ? 'selected' : ''); ?>>
                                                                            Krim</option>
                                                                        <option value="Fls"
                                                                            <?php echo e($jenis == 'Fls' ? 'selected' : ''); ?>>Fls
                                                                        </option>
                                                                        <option value="Ampul"
                                                                            <?php echo e($jenis == 'Ampul' ? 'selected' : ''); ?>>
                                                                            Ampul</option>
                                                                        <option value="Vial"
                                                                            <?php echo e($jenis == 'Vial' ? 'selected' : ''); ?>>
                                                                            Vial</option>
                                                                        <option value="Puyer/Racikan"
                                                                            <?php echo e($jenis == 'Puyer/Racikan' ? 'selected' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group mt-3">
                                    ...
                                    <textarea name="obat_racikan" id="obat_racikan" class="form-control mt-2" rows="3" disabled><?php echo e($item->obat->soap->ObatRacikan ?? 'Tidak ada obat racikan'); ?></textarea>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group mt-3">
