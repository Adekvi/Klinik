<div class="modal fade" id="poto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/master/anjuran-tambah')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_anjuran" id="kode_anjuran"
                                    class="form-control mt-2 mb-2" placeholder="Nama Anjuran Minum">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/dataanjuran/tambah.blade.php ENDPATH**/ ?>