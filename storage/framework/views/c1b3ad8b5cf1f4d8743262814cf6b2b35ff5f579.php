                    ...
                    <div class="card shadow-sm mb-4 mt-4">
                        ...
                        <div class="card-body">
                            <div class="row g-2 mt-2">
                                <div class="col-md-6">
                                    <div><strong>Nama :</strong> <?php echo e($antrianDokter->booking->pasien->nama_pasien); ?></div>
                                </div>
                                <div class="col-6">
                                    <div><strong>Tanggal Lahir :</strong>  <?php echo e(\Carbon\Carbon::parse($antrianDokter->booking->pasien->tgllahir)->translatedFormat('d F Y')); ?></div>
                                </div>
                                <div class="col-md-6">
                                    <div><strong>Umur :</strong> <?php echo e(\Carbon\Carbon::parse($antrianDokter->booking->pasien->tgllahir)->age); ?> Tahun</div>
                                </div>
                                <div class="col-md-6">
                                    <div><strong>No. RM :</strong> <?php echo e($antrianDokter->booking->pasien->no_rm); ?></div>
                                </div>
                                <div class="col-md-6">
                                    <div><strong>Jenis Kelamin :</strong> <?php echo e($antrianDokter->booking->pasien->jekel ?? '-'); ?></div>
                                </div>
                                <div class="col-md-6">
                                    <div><strong>Alamat Asal :</strong> <?php echo e($antrianDokter->booking->pasien->alamat_asal ?? '-'); ?></div>
                                </div>
                                <div class="col-md-6">
                                    <div><strong>Domisili :</strong> <?php echo e($antrianDokter->booking->pasien->domisili ?? '-'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
