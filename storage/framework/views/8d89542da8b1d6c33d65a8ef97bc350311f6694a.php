                        ...
                        <div id="isian mt-3 mb-2">
                            <label for="isian-ya">
                                <input type="radio" name="isian" checked id="isian-ya"
                                    ...
                                    <?php echo e($antrianDokter->isian->p_form_isian_pilihan === 'auto-anamnesis' ? 'checked' : ''); ?>>
                                Auto Anamnesis
                            </label>
                            <label for="isian-tidak">
                                <input type="radio" name="isian" id="isian-tidak"
                                    ...
                                    <?php echo e($antrianDokter->isian->p_form_isian_pilihan === 'Aloanamnesis' ? 'checked' : ''); ?>>
                                Aloanamnesis
                            </label>
                        </div>
                ...
                <div class="input-row">
                    ...
                    <div class="input-wrapper">
                        <div class="multi-select-wrapper form-control" data-input-id="modal-resep_${kolomIndex}">
                            ...
                            <input type="text" class="autocomplete-input multi-select-input" id="modal-resep_${kolomIndex}" placeholder="Cari Obat" autocomplete="off" data-url="<?php echo e(url('/resep-autocomplete')); ?>" data-dropdown="modal-dropdown-resep_${kolomIndex}">
                        </div>
                ...
                <div class="input-row">
                    ...
                    <div class="input-wrapper">
                        <div class="multi-select-wrapper form-control" data-input-id="modal-jenis_obat_${kolomIndex}">
                            ...
                            <input type="text" class="autocomplete-input multi-select-input" id="modal-jenis_obat_${kolomIndex}" placeholder="Cari Jenis Obat" autocomplete="off" data-url="<?php echo e(url('jenis-autocomplete')); ?>" data-dropdown="modal-dropdown-jenis_obat_${kolomIndex}">
                        </div>
                ...
                <div class="input-row">
                    ...
                    <div class="input-wrapper">
                        <div class="multi-select-wrapper form-control" data-input-id="modal-aturan_${kolomIndex}">
                            ...
                            <input type="text" class="autocomplete-input multi-select-input" id="modal-aturan_${kolomIndex}" placeholder="Cari Aturan Pakai" autocomplete="off" data-url="<?php echo e(url('aturan-autocomplete')); ?>" data-dropdown="modal-dropdown-aturan_${kolomIndex}">
                        </div>
                ...
                <div class="input-row">
                    ...
                    <div class="input-wrapper">
                        <div class="multi-select-wrapper form-control" data-input-id="modal-anjuran_${kolomIndex}">
                            ...
                            <input type="text" class="autocomplete-input multi-select-input" id="modal-anjuran_${kolomIndex}" placeholder="Cari Anjuran Minum" autocomplete="off" data-url="<?php echo e(url('anjuran-autocomplete')); ?>" data-dropdown="modal-dropdown-anjuran_${kolomIndex}">
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/dokter/modal/modalSoap.blade.php ENDPATH**/ ?>