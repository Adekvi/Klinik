...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\Layout\Terminal::class, ['title' => 'Admin | Rekap Obat Keluar']); ?>
                            ...
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $obat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo e(date_format(date_create($item->created_at), 'd-m-Y / H:i')); ?></td>
                                            <td>
                                                <?php $__currentLoopData = $namaObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $resep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <ul>
                                            ...
                                            <td>
                                                <?php $__currentLoopData = $aturan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jumlah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <ul>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/obat-Keluar.blade.php ENDPATH**/ ?>