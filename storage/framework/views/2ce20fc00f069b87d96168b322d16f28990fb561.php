<?php $__currentLoopData = $obat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="hapusobat<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('apoteker/master-obat/obat-hapus/' . $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/obat/master/dataobat/hapus.blade.php ENDPATH**/ ?>