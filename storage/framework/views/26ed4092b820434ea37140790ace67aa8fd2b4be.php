<?php if($obat->count() > 0): ?>
    <?php $__currentLoopData = $obat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr class="text-center" style="white-space: nowrap">
            ...
            <td>
                <?php if($item->golongan == null): ?>
                    -
                <?php else: ?>
                    <?php echo e($item->golongan); ?>
            ...
            <td>
                <div class="aksi d-flex" style="white-space: nowrap">
                    ...
                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                        data-bs-target="#hapusobat<?php echo e($item->id); ?>">
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/obat/master/dataobat/table.blade.php ENDPATH**/ ?>