<?php $__currentLoopData = $diagnosa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="hapusdiagnosa<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/hapus/diagnosa/' . $item->id)); ?>" method="POST"
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/diagnosa/modalhapus.blade.php ENDPATH**/ ?>