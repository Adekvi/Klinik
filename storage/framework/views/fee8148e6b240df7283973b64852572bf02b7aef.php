    ...
    <div class="modal fade" id="editpoli<?php echo e($item->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/master/ppn-edit/' . $item->id)); ?>" method="post"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2 mb-2" value="<?php echo e($item->namaPajak); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" value="<?php echo e($item->tarifPpn); ?>"
...
<?php /**PATH E:\xampp\htdocs\Job_Rs_Master\resources\views/admin/master/ppn/edit.blade.php ENDPATH**/ ?>